...
## Asociación o correlación no significa causalidad
...
```{r}
regLA <- lm(totAlcohol ~ totLiteracy, data = literacyAlcohol)
summary(regLA)
```
...
```{r}
regLA <- lm((totAlcohol / popu) ~ I(totLiteracy / popu), data = literacyAlcohol)
summary(regLA)
```
