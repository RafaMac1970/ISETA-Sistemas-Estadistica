...
Esto se muestra para verificar la capacidad del método, pero no es una práctica recomendable hacerlo con tanta cantidad de variables y datos. De todos modos puede verse la enorme utilidad que podría tener esto en la exploración de algunos casos. Muy rápidamente se puede contar con un panorama general muy detallado.
...
```{r}
gr1 <- ggplot(iris, aes(x = Petal.Length, fill = Species)) +
