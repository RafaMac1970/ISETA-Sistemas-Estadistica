...
La demanda de profesionales capacitados en ciencia de datos está creciendo rápidamente. Aquí se introduce a la adqusición de habilidades que pueden ayudar a enfrentar desafíos de análisis de datos del mundo real. Estas incluyen programación, manipulación y visualización de datos en R, organización de archivos, control de versiones con Git y GitHub, y preparación de documentos reproducibles knitr. Cada parte tiene varios capítulos diseñados para ser presentados como una clase e incluye ejercicios para cada capítulo en documentos aparte.
...
Para insertar un nuevo chunk puede hacerlo desde el menú "Code / Insert Chunk", con el botón verde a la derecha de este panel (que tiene un símbolo + y una C), despliega un menú y elige R, o con las teclas rápidas Alt+Ctrl+I.
