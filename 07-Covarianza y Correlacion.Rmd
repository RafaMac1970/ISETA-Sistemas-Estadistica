...
```{r}
p <- ggplot(iris, aes(x = Petal.Length, y = Petal.Width, color = Species, size = Sepal.Length, alpha = 0.2)) +
      geom_point() +
      geom_smooth(method = "lm", se = FALSE) +
