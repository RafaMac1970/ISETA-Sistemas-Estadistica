...
Se utilizarán los datos del built-in dataset warpbreaks.
...
-   En caso de encontrar significancia, realice un análisis post-hoc adecuado y grafique los resultados.
