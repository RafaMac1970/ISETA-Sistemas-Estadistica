...
> AVISO !!: Si realiza estos ejercicios con IA's lo más probable es que no aprenda lo básico de R. En próximas clases les mostraré cómo usar IA's para resolver problemas con R, pero primero hay que aprender la sintáxis y lógica de trabajo de R, y no existen atajos para ello, hay que pensar y transpirar... :o). Resolver todos estos ejercicios me llevó algo más de una hora y media, es esperable que usted requiera varias horas y consultas conmigo y sus compañeros.
...
-   Imagine una inflación mensual del 7% y construya 2 arrays (uno con la recaudación y otro con las ganacias) con la información del ejercicio anterior agregándole la información del mes siguiente.
